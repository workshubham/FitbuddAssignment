...
//  Outpost
//
//  Created by Prinks Rohit on 15/12/20.
//  Copyright © 2020 Spiderorb. All rights reserved.
//
import UIKit
import ObjectiveC
    ...
    */
    func toastViewForMessage(_ message: String?, title: String?, image: UIImage?, style: ToastStyle) throws -> UIView {
        ...
        if let messageLabel = messageLabel {
            ...
            messageRect.size.height = imageView != nil ? imageView!.bounds.size.height : messageLabel.bounds.size.height
        }
...
public struct ToastStyle {
    ...
    */
    public var imageSize = CGSize(width: 30.0, height:30.0)
...
public enum ToastPosition {
    ...
    fileprivate func centerPoint(forToast toast: UIView, inSuperview superview: UIView) -> CGPoint {
        ...
        let bottomPadding: CGFloat = ToastManager.shared.style.verticalPadding + superview.csSafeAreaInsets.bottom + 10
